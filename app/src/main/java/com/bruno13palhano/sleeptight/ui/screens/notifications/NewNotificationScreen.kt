...
fun NewNotificationScreen(
    ...
    NewNotificationContent(
        ...
        onDescriptionChange = { descriptionValue -> description = descriptionValue },
        onTitleDone = { focusManager.clearFocus(force = true) },
        onDescriptionDone = { focusManager.clearFocus(force = true) },
        onTimeClick = { focusManager.clearFocus(force = true) },
        onDateClick = { focusManager.clearFocus(force = true) },
